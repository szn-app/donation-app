...
-- $1: VARCHAR(150) - title
-- $2: TEXT - description
-- $3: community_type - variant ('solo' or 'organized')
-- $4: UUID - owner account id
-- $5: UUID - created_by account id

INSERT INTO "user"."community" (title, description, variant, owner, created_by)
VALUES ($1, $2, $3, $4, $5)
RETURNING id, title, description, variant, owner, created_at, updated_at, created_by; 
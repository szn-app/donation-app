...
export const useDummyQuery = <
    ...
    return useQuery<DummyQuery, TError, TData>(
      variables === undefined ? ['Dummy'] : ['Dummy', variables],
      fetcher<DummyQuery, DummyQueryVariables>(dataSource.endpoint, dataSource.fetchParams || {}, DummyDocument, variables),
      options
    )};

export const Dummy2Document = `
    query Dummy2 {
  __typename
}
    `;

export const useDummy2Query = <
      TData = Dummy2Query,
      TError = unknown
    >(
      dataSource: { endpoint: string, fetchParams?: RequestInit },
      variables?: Dummy2QueryVariables,
      options?: UseQueryOptions<Dummy2Query, TError, TData>
    ) => {
    
    return useQuery<Dummy2Query, TError, TData>(
      variables === undefined ? ['Dummy2'] : ['Dummy2', variables],
      fetcher<Dummy2Query, Dummy2QueryVariables>(dataSource.endpoint, dataSource.fetchParams || {}, Dummy2Document, variables),
      options
    )};
